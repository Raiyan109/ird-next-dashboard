...
export default function Home() {
  return (
    <div>
      {/* <!-- component --> */}
      <div class="bg-[#F7F8FA] min-h-screen flex w-full">
        <div class=" flex-1 flex flex-col lg:flex-row  space-y-5 lg:space-y-0  lg:space-x-10  sm:p-6 sm:my-2 sm:mx-4 sm:rounded-2xl">
          {/* <!-- Side Navigation --> */}
          <SideNav />
          {/* <!-- Content --> */}
